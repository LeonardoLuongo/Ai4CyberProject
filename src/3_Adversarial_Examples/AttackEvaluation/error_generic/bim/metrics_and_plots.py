...
def main():
    print("======================================================")
    print(" METRICHE & PLOT: BIM ERROR-GENERIC (Untargeted)      ")
    print("======================================================\n")
    ...
    # =========================================================
    attacks_dir = base_dir / "dataset" / "attacks" / "error_generic" / "bim"
    output_eval_dir = base_dir / "plots" / "3_Adversarial_Examples" / "error_generic" / "bim"
    ...
    evaluated_csv_path = output_eval_dir / "bim_untargeted_evaluated.csv"
    ...
    asr_dict = {"BIM Untargeted (Robust Acc)": []}
    confidence_data = []
    ...
    for eps in epsilons:
        ...
        asr_dict["BIM Untargeted (Robust Acc)"].append(robust_accuracy)
        ...
        if hasattr(logger, 'log_attack_metrics'):
            ...
            logger.log_biometric_metrics(
                ...
                epsilon=eps,
                defense_type="None",
                accuracy=robust_accuracy, # In untargeted, Accuracy = Robust Accuracy
                eer=0.0,
                far=0.0,
                frr=0.0,
                threshold=0.0,
    ...
    plot_confidence_degradation(epsilons, confidence_data, "BIM Untargeted", True, str(output_eval_dir / "confidence_degradation.png"))
