...
def main():
    print("======================================================")
    print(" GENERATORE CAMPIONI: PGD ERROR-GENERIC (UNTARGETED)  ")
    print("======================================================\n")
    ...
    # PARAMETRI PGD
    epsilons = [0.001, 0.003, 0.005, 0.010, 0.015, 0.020]
    PGD_MAX_ITER = 4
    STEP_MULT = 1.5
    NUM_INIT = 3
    BATCH_SIZE = 128
    ...
    print(f"-> Immagini d'oro pronte per l'attacco Untargeted: {total_valid} ({cached_count} caricate da cache TIFF)")

    # =========================================================================
    # FASE 2: GENERAZIONE DEGLI ATTACCHI UNTARGETED (BATCH DIRETTO)
    # =========================================================================
    print(f"\n======================================================")
    print(f" AVVIO GENERAZIONE ERROR-GENERIC PGD")
    print(f"======================================================")
    ...
    for eps in epsilons:
        ...
        # Logica passo PGD
        current_eps_step = (eps / PGD_MAX_ITER) * STEP_MULT
        
        print(f"\n[>>>] Generazione Untargeted Epsilon = {eps:.3f} | Step = {current_eps_step:.4f} | Iter = {PGD_MAX_ITER}")
    ...
    print("\n[OK] Processo PGD Error-Generic completato con successo e immagini TIFF salvate via OpenCV!")
