...
def main():
    print("======================================================")
    print(" METRICHE & PLOT: C&W TRANSFERABILITY NN1 -> NN2      ")
    print("======================================================\n")
    ...
    output_eval_dir = base_dir / "plots" / "5_NN2_Adversarial_Examples" / "NN2" / "error_generic" / "cw"
    ...
    with torch.inference_mode():
        for i in tqdm(
            ...
            for _, row in batch_df.iterrows():
                ...
                x_clean_batch.append(preprocess_for_senet(clean_bgr))
                x_adv_batch.append(preprocess_for_senet(adv_bgr))
    ...
    for eps in epsilons:
        ...
        asr_dict["C&W Transfer NN1->NN2"].append(robust_accuracy)
        ...
        if hasattr(logger, "log_attack_metrics"):
            logger.log_attack_metrics(
                tester="Andrea",
                attack_type="C&W Transfer NN1->NN2",
                strategy="Untargeted",
                epsilon=eps,
                defense_type="None",
    ...
    print("\n[OK] Pipeline C&W Transferability NN1 -> NN2 conclusa con successo!")
