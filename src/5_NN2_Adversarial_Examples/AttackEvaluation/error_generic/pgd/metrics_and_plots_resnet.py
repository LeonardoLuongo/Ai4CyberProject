...
def main():
    print("================================================================")
    print(" METRICHE & PLOT: PGD TRANSFERABILITY NN1 -> RESNET50-SCRATCH  ")
    print("================================================================\n")
    ...
    robust_accuracy_curve = {"PGD Transfer NN1->ResNet50-Scratch": []}
    confidence_data = []
    transfer_asr_values = []
    metric_rows = []
    ...
    for eps in epsilons:
        ...
        robust_accuracy_curve["PGD Transfer NN1->ResNet50-Scratch"].append(robust_accuracy)
        ...
        if logger is not None:
            logger.log_attack_metrics(
                tester="Andrea",
                attack_type="PGD Transfer NN1->ResNet50-Scratch",
    ...
    plot_confidence_degradation(
        epsilons,
        confidence_data,
        "PGD Transfer NN1->ResNet50-Scratch",
        True,
    ...
    print("\n[OK] Valutazione transferability PGD NN1 -> ResNet50-Scratch completata.")
