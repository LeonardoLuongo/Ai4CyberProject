...
def main():
    print("================================================================")
    print(" METRICHE & PLOT: FGSM TRANSFERABILITY NN1 -> RESNET50-SCRATCH")
    print("================================================================\n")
    ...
    robust_accuracy_curve = {"FGSM Transfer NN1->ResNet50-Scratch": []}
    confidence_data = []
    transfer_asr_values = []
    metric_rows = []
    ...
    for eps in epsilons:
        ...
        robust_accuracy_curve["FGSM Transfer NN1->ResNet50-Scratch"].append(robust_accuracy)
        ...
        if logger is not None:
            logger.log_attack_metrics(
                tester="Andrea",
                attack_type="FGSM Transfer NN1->ResNet50-Scratch",
    ...
    plot_confidence_degradation(
        epsilons,
        confidence_data,
        "FGSM Transfer NN1->ResNet50-Scratch",
        True,
    ...
    print("\n[OK] Valutazione transferability FGSM NN1 -> ResNet50-Scratch completata.")
